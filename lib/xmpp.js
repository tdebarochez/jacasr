...
/**
 * == Jacasr ==
 * Jacasr is a pure JS XMPP library
 *
 **/
...
//     sys.puts('setSecure');
  ...
  xml_parser = sax.parser(true, {xmlns: true, trim: true});
  xml_parser.onopentag = function (elt) {
    var name = '';
  ...
  xml_parser.onclosetag = function (tag_name) {
  ...
  xml_parser.ontext = function (str) {
    value += str;
  };
  xml_parser.oncdata = function (str) {
    cdata += str;
  };
